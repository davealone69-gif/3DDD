...
class ModelLoader(
    ...
    private fun buildPiece(parsed: GltfDocument.Document, primitive: GltfDocument.Primitive): Piece? {
        ...
        val normals = primitive.normals ?: GeometryTools.computeNormals(primitive.positions, primitive.indices)
        val tangents = GeometryTools.packTangents(normals, primitive.positions, primitive.uvs, primitive.indices, primitive.tangents)
